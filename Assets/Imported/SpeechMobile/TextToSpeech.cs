...
{
	[AddComponentMenu("Text & Speech Mobile/Text To Speech")]
    public class TextToSpeech : MonoBehaviour
    {
        ...
        public Action onStartCallback, onDoneCallback;
        public Action<string> onSpeakRangeCallback;

        [Range(0.5f, 2)] public float
			pitch = 1f, //[0.5 - 2] Default 1
			rate = 1f; //[min - max] android:[0.5 - 2] iOS:[0 - 1]
